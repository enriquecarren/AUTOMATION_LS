...
WebUI.click(findTestObject('Object Repository/Specific Cases Repository/FD/client profile estimates creation/Page_Home/a_Census'))

WebUI.click(findTestObject('Object Repository/Specific Cases Repository/FD/client profile estimates creation/Page_Home/a_E Automation, E Client'))

WebUI.click(findTestObject('Object Repository/Specific Cases Repository/FD/client profile estimates creation/Page_Client Profile/a_Financial'))
