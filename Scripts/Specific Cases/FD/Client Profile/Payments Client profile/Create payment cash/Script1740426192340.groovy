...
WebUI.navigateToUrl('https://site17.lsapp.cloud/payment/create/1680/1633')
...
WebUI.click(findTestObject('Object Repository/Specific Cases Repository/FD/CLIENT FINANCIAL/payment CP/Page_Collect Payment/button_Add Row'))

WebUI.setText(findTestObject('Object Repository/Specific Cases Repository/FD/CLIENT FINANCIAL/payment CP/Page_Collect Payment/input_Amount_lineamount_1'), 
    '50')

WebUI.setText(findTestObject('Object Repository/Specific Cases Repository/FD/CLIENT FINANCIAL/payment CP/Page_Collect Payment/textarea_Note_note'), 
    'cash payment')

WebUI.click(findTestObject('Object Repository/Specific Cases Repository/FD/CLIENT FINANCIAL/payment CP/Page_Collect Payment/button_Save'))
